  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
      ...
      if (response.success) {
        ...
        reviewEditMark.value = response.userMark;
      } else {
...
let reviewEditMark = document.querySelector(".order__menu-mark_edit");
...
reviewEditBtn.addEventListener("click", () => {
  ...
  let updatedUserMark = reviewEditMark.value;
  ...
  formData.append("userMark", updatedUserMark);

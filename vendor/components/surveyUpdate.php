<div class="survey__update">
            <div class="order-inside">
                ...
                <form action="" name="survey-form" class="order__form" method="post">
                    ...
                    <select name="user_service" id="" class="order__menu registration__input order__menu-mark_edit" required pattern="[0-5]{1}" minlength="1" maxlength="1">
